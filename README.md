...
No human wrote any of the C++ in this diff. The human provided the goal, tested the result in-game, and reported that the first attempt didn't work (because of the `GL_REPLACE` issue). Claude diagnosed and fixed it.
